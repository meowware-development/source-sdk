...
// Call ClientClass::Dump() somewhere then replace it.
...
using CreateClientClassFn = ClientNetworkable * (*)(int entNumber, int serialNumber);
using CreateEventFn = ClientNetworkable * (*)();
